...
import { FiMenu, FiX, FiUser, FiSearch, FiShoppingCart, FiHome, FiGrid, FiLogOut } from "react-icons/fi";
    ...
    <>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 px-4 py-4">
            <ul className="flex flex-col space-y-4">
              ...
              >
                <span className="bg-orange-100 rounded-full px-2 py-1">Flash Deals</span>
              </li>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40 py-2 px-6 shadow-lg">
        <div className="flex justify-around items-center">
          ...
          <button
            onClick={() => setCategoryOpen(!categoryOpen)}
            className={`flex flex-col items-center ${categoryOpen ? 'text-teal-600' : 'text-gray-600'}`}
          >
            <FiGrid size={20} />
          ...
          >
            <div className="relative">
              ...
              {cartCount > 0 && (
                <span className="absolute -top-2 -right-3 bg-sky-500 text-white text-xs font-bold h-5 w-5 flex items-center justify-center rounded-full">
                  {cartCount}
                </span>
              )}
            </div>
