...
const categories = [
  { label: "Tech Products", icon: "📱", discount: "Up to 60% OFF", route: "/tech" },
  { label: "Fashion", icon: "👗", discount: "Up to 70% OFF", route: "/fashion" },
  { label: "Ayurvedic", icon: "🌿", discount: "Up to 50% OFF", route: "/ayurvedic" },
];
